...
def draw_text_box(column=None, row=None, width=None, height=None, text="", text_area=None, overwrite=False):
    ...
    :precondition: column must be a positive integer greater than 0 within the bound of the terminal
    :precondition: row must be a positive integer greater than 0 within the bound of the terminal
